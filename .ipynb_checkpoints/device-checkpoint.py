...
def open(device=None, target_name=None, config=0):
    """
        ...
        returns:    - device data
    """
    device_types = [("Analog Discovery", constants.devidDiscovery), ("Analog Discovery 2", constants.devidDiscovery2),
    ...
    if device_handle.value != 0:
        ...
        dwf.FDwfEnumUserName(ctypes.c_int(0), device_name)
    ...
    data.name = device_name.value.decode("ascii")
